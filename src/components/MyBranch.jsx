...
const MyBranch = () => {
    ...
    return (
        <ManagerLayout>
            <h1 className="text-2xl font-bold text-[#274E6B] mb-6">My Branch</h1>
            ...
            {showPersonalInfoModal && <PersonalInfoModal onClose={() => setShowPersonalInfoModal(false)} onSuccess={handleApplicantSuccess} id={null} />}
        </ManagerLayout>
    );
};
