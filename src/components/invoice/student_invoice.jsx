...
const StudentInvoice = ({ invoiceDetails }) => {
        ...
        <div className="invoice-container">
            ...
            <div className="second-page mt-16 mb-16">
                ...
                <div className="text-justify mt-5">
                    ...
                    <strong>Obligations of Students:</strong>
                    <ul className="list-disc pl-6 space-y-2">
                        <li>The student is responsible for providing original documents as required by the consultant. If not, they will face the consequences.</li>
                        <li>The student shall ensure timely payments of all applicable fees and charges.</li>
                        <li>The student shall appear in person at any relevant offices, as instructed by the company.</li>
                    </ul>

                    <strong>Obligations of Company:</strong>
                    <ul className="list-disc pl-6 space-y-2">
                        <li>The Consultant will keep the student informed about the progress of the visa application.</li>
                    </ul>
            ...
            {/*Third Page*/}
            <div className="third-page mt-16">
                <div className="flex items-center p-6 bg-white">
                    {/* Logo on the left */}
                    <div className="flex items-center">
                        <img
                ...
                <div className="text-justify mt-5">
                    <strong>Fee Structure: (For Regular Students)</strong>
                    The Consultancy fee is <strong>80,000 PKR</strong>, which includes admission, entry visa permit and visa sticker.The student should provide document, if want attestation services from counsultancy additional should be paid in advance.<br/>
                    Tution fee is mentioned on acceptance letter should be paid by student, before offer letter expiration.<br/>
                    Visa sticker fee and documents fee may vary because of euro rate. Average is <strong>135K PKR</strong>.<br/>
                    <strong>Non-Refund:</strong>
                    <ul className="list-disc pl-6 space-y-2">
                        <li>In the case where a visa is refused due to fake or fraudulent documents, the fee paid by the student will not be refunded.</li>
                        <li>If a student is found medically unfit in (Country) and shows fake documents, the above consideration will apply.</li>
                    </ul>
